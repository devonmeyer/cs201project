...
public class PopupRobotAgent extends Agent implements Robot{
	...
	public boolean pickAndExecuteAnAction() {
		...
		if(myglass != null){
			if(myglass.gstate == GlassState.processing){
				processGlass();
				return true;
			}
		}
		...
		if(myglass != null){
			if(myglass.gstate ==  GlassState.processed && pstate != PopupState.popupready && pstate != PopupState.requested){
				requestPopup();
				return true;
			}
		}
		...
		/*if(myglass != null){
			if(myglass.gstate == GlassState.removing && pstate == PopupState.popupready){
				removeGlass();
				return true;
			}
		}*/
