 ...
 * Any class implementing the Receiver interface can use the Transducer to
 * send and listen to events on any property channel.
 * 
 * @author Jon Sun
 */
public class Transducer
{
	 ...
	 * All Receivers listening to the property will be notified.
	 * It is the Receiver's responsibility to parse the eventMessage in a meaningful way.
	 * 
